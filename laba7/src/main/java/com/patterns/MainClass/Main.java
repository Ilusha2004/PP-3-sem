...
import com.patterns.Menu.Decorator.AnotherDecorators.AmountDecorator;
...
public class Main {
    ...
    public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
        ...
        for(var id : dec) {
            id = new CoffeeDecorator(new DessertDecorator(new TableDecorator(new TypeDecorator(new AmountDecorator(new MainComponents())))));
            id.setPosition();
        }
